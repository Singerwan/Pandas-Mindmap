...
#  <div style="background-color:silver;color:crimson">![rank](./images/update.png "s" )sort filter select &nbsp;</div>
## summary
### sort 
### filter 
### select 
...
# <div style="background-color:magenta;color:blue">  ![rank](./images/reshapetransform.png "s" )Reshape Join + | 1 &ensp;&nbsp;&nbsp;<br>&emsp;&emsp; &emsp;axis &rarr;row 0 col 1<br>&emsp;&emsp;&emsp;row zero | vertical 1</div>
...
##### illustration 1
#####  ![rank](images/hover.png "s" )
* illustration 2 -only highlight cell 
* ![rank](images/hovercell.png 's')
...
##### illustration 
#####  ![rank](images/tabledfborders.png "s" )
...
###### illustration 
######  ![rank](images/conditionalformatting.png "s" )
#### step3 df.map(def)
# pd. summary
## option | set option
