...
##### csv  
###### c&rarr;comma 
###### &emsp;s &rarr; separated
###### &emsp;&emsp;v- &rarr;value
...
### syntax 
#### axes, fig =plt.subplot(row_number,col_number,figsize=(width, height))
### ax[0,0].plot
...
###### common pitfalls
* notes
* <div style="background-color:indigo">Does not remove characters from the middle of the string.<br> Passing "abc" removes all 'a', 'b', 'c' from both ends, not "abc" as a block.</div>
